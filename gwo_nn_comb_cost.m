...
% Objective Function
objectiveFunction = @(P_load) sum(calculate_hourly_cost(P_load, P_renewable_no)) + ...
...
Pload_opt_nngwo_comb_cost = Pload_opt_nn;  % Assign the variable properly
assignin('base', 'Pload_opt_nngwo_comb_cost', Pload_opt_nngwo_comb_cost);
